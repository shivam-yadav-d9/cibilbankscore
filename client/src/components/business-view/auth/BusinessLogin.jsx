...
const BusinessLogin = () => {
  ...
  const BUSINESS_EMAIL = "business@dbnpe.com";
  ...
  const handleLogin = async (e) => {
    ...
    setTimeout(() => {
      try {
        ...
        if (email === BUSINESS_EMAIL && password === BUSINESS_PASSWORD) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-blue-900 to-indigo-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-indigo-300 font-medium">Business Portal</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
            ...
            <div className="px-8 pt-8 pb-4">
              <h2 className="text-center text-2xl font-bold text-white tracking-tight">Business Access</h2>
            ...
            <div className="px-8 pb-8">
                ...
                <div>
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      placeholder="business@dbnpe.com"
                    />
                  </div>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-indigo-200">
                  Don't want to create business account?{" "}
