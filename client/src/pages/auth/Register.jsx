            ...
            <div className="px-8 pb-8">
                  ...
                  >
                    {loading ? (
                      ...
                      <span className="flex items-center">
                        Sign up
                        <svg
                          className="ml-2 -mr-1 h-4 w-4 group-hover:translate-x-1 transition-transform duration-200"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-indigo-200">
                  ...
                  <Link
                    to="/login"
                    className="font-medium text-indigo-400 hover:text-white transition-colors duration-200"
                  >
                    Sign in
                  </Link>
                </p>
